...
class DinoV2ExtractFeatures:
    ...
    def __init__(self, dino_model, layer: int, 
        ...
        self.dino_model: nn.Module = torch.hub.load('/home/dell/.cache/torch/hub/facebookresearch_dinov2_main', dino_model, source='local')
...
class AnyLoc(nn.Module):
    # Constructor
    def __init__(self, dino_model = "dinov2_vits14", 
